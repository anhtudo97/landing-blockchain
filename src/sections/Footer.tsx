  ...
  return (
    <footer className="py-24 bg-zinc-950">
      <div className="container">
        ...
        <div className="mt-12 md:mt-48 flex items-center justify-between">
          <p className="text-zinc-400">
            &copy; 2024 Blockchain. All right reserved.
          </p>
          <div className="mt-4 md:mt-0 inline-flex items-center gap-6">
